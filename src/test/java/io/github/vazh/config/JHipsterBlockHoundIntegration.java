...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("io.github.vazh.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("io.github.vazh.security.DomainUserDetailsService", "createSpringSecurityUser");
